-- ==============================================================================
-- STAGE 22: Phase 3 Final Voting Rules (All Valid Products Eligible)
-- IPL-2026 Platform
...
-- 1. Phase 3 Atomic cast_vote RPC Function (Shortlist Restriction Removed)
-- Strictly enforces:
...
-- 5. Duplicate vote check: ONE VOTE PER IDEA/PRODUCT (voter_user_id + product_id)
-- 6. Own-team vote restriction (Leader and Members; Mentor strictly ignored)
-- 7. Department clash restriction (Leader and Members; Mentor strictly ignored)
-- 8. Atomic recording into public.product_votes, public.product_vote_counts, and public.team_votes
-- NOTE: In Stage 22, voting eligibility is NOT restricted by shortlist status.
-- Both shortlisted and non-shortlisted products are eligible to receive community votes.
-- Shortlist status is reserved for public leaderboard priority ordering and badges.
